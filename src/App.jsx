...
<div className="react-newsletter-container">
  <div className="react-content-column">
    <h2>Herb Insider</h2>
    <p>Subscribe to Herb’s bi-weekly and monthly dose of cannabis updates and stay informed with the latest news, top strains, hottest products, and unbeatable deals. </p>
  </div>
  <input id= "newsletter-email" type="email" placeholder="Your email address" className="react-newsletter-input"></input>
  <a  className="react-subscribe-button" href="#">Subscribe</a>
</div>
    </section>
...
<h2 className="featured-article-title">Cannabis Marketing <br/> Agencies Vs. General Digital <br/> Or Advertising Agencies</h2>
</div>
   </div>
    </div>
    <div class="react-featuredright-column">
      ...
      <div class="react-featured-article-right-content-column">
        <p>June 20th, 2025</p>
        <h3>The Evolution of <br/>
Stoner Games: From <br/>
High School Classics to Modern Party Rituals</h3>
      </div>
      </div>
      <div class="react-flex-column">
        <div class="react-featured-article-right-column-image">
      ...
      <div class="react-featured-article-right-content-column">
        <p>June 18th, 2025</p>
        <h3>How to Use a One-Hitter <br/> Like a Pro: Packing Tips,<br/> Cleaning Tricks, and <br/> Stealth Strategies</h3>
      </div>
      </div>
       <div class="react-flex-column">
        <div class="react-featured-article-right-column-image">
      ...
      <div class="react-featured-article-right-content-column">
        <p>June 13th, 2025</p>
        <h3>Why Does Weed Make <br/> Food Taste Better? The <br/> Science of the Munchies</h3>
      </div>
      </div>
    </div>
    </div>
      ...
      <div className="react-latest-article-section-content">
        <div className = "react-latest-article-card">
          ...
          <p>June 17th, 2025</p>
          <h3>How Different<br/>Consumption Methods<br/>Affect Your High</h3>
          </div>
          </div>
           <div className = "react-latest-article-card">
          <div clasName="react-latest-article-card-image">
            ...
            <div className="react-latest-article-card-title">
          <p>June 13th, 2025</p>
          <h3>The Ultimate Chill Kit: <br/>Everything You Need for <br/> the Perfect Smoke Sesh</h3>
          </div>
          </div>
      </div>
    <section className="react-learning-carrousel">
     ...
     <svg width="53px" height="53px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
        ...
        <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>June 19th, 2025</p>
                <h3> Does THC Sparkling<br/> Water Work? Here’s <br/> What It Feels Like </h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>June 17th, 2025</p>
                <h3> Dry Herb Vaporizer vs.<br/> Oil Carts: Which Is<br/> Healthier in 2025?</h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>June 16th, 2025</p>
                <h3> High Standards: 7 Cannabis <br/>  Products the Herb Team <br/> Can’t Live Without </h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>June 19th, 2025</p>
                <h3> 5 LGBTQ+ Owned<br/>Cannabis Brands To Support <br/> During Pride Month</h3>
                </div>
              </div>
              </div>
            </div>
        ...
        <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              <img src = "src\assets\news-image-1.png"></img>
              <p>May 13th, 2025</p>
                <h3> Will Trump Legalize Weed <br/>Federally? Analyzing the <br/> Possibilities Ahead </h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              <img src = "src\assets\image 1.png"></img>
              <p>May 7th, 2025</p>
                <h3> Marc Emery: A Cannabis <br/> Activist’s Journey Through <br/>Trials and Triumphs</h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              <img src = "src\assets\news-image3.png"></img>
              <p>April 14th, 2025</p>
                <h3> Herb’s Digital 4/20 Scavenger <br/> Hunt Makes Cannabis History <br/> With Massive Prize Pool</h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              <img src = "src\assets\news-image4.png"></img>
              <p>May 15th, 2025</p>
                <h3> EdiblesExpress: Chicago’s <br/>Go-To Online Edible Store<br/>Has Officially Launched</h3>
                </div>
              </div>
              </div>
            </div>
    ...
    <section className="react-learning-carrousel">
       <div class= "swiper custom-react-swiper">
      <div className="react-learning-carrousel-header">
        <h2 className="react-learning-carrousel-header-heading">CULTURE</h2>
         <div class="nav-buttons">
      <div class="nav-previous-button">
     <svg width="53px" height="53px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
    ...
    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
          ...
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>January 8th, 2025</p>
                <h3> Say Hello To 2025<br/>With These 5 Strains </h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>November 11th, 2025</p>
                <h3> What It’s Like To <br/>Smoke Weed In China</h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>November 23rd, 2025</p>
                <h3> 10 Biggest Celebrity <br/>Stoners You Should Know </h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>August 11th, 2025</p>
                <h3> This Is Why Making Out <br/>While High Is So Hot </h3>
                </div>
              </div>
              </div>
            </div>
       ...
       <div class= "swiper custom-react-swiper">
      <div className="react-learning-carrousel-header">
        <h2 className="react-learning-carrousel-header-heading">REVIEWS</h2>
         <div class="nav-buttons">
      <div class="nav-previous-button">
     <svg width="53px" height="53px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
        ...
        <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>April 10th, 2025</p>
                <h3> Tested & Reviewed:  <br/>Bloomz AAA Exotic Flower</h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>April 17th, 2025</p>
                <h3> Tested & Reviewed: <br/> HempLucid’s New D9 THC <br/>& CBD Gummies</h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>April 15th, 2025</p>
                <h3> Galaxy Treats Reviews:<br/>Orbital Gummies </h3>
                </div>
              </div>
              </div>
               <div class = "swiper-slide">
          <div class="react-slide-card">
            <div class="slide-card-image">
              ...
              <p>March 26th, 2025</p>
                <h3> Soul CBD Reviews:<br/>Out  Of Office Drink </h3>
                </div>
              </div>
              </div>
            </div>
